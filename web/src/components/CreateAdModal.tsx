...
export function CreateAdModal() {
    ...
    return(
        ...
        <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-[5%] left-1/2 -translate-x-1/2 -translate-y-1-/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
